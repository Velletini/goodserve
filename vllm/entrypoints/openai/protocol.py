...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    proxy_request_id: Optional[str] = None #新增proxy_request_id字段
    original_prompt_len: Optional[int] = Field(default=-1)
...
class CompletionRequest(OpenAIBaseModel):
    ...
    deadline: Optional[float] = None
    proxy_request_id: Optional[str] = None #新增proxy_request_id字段
    problem : Optional[str] = None #新增problem字段
    total_generated_len: int = 0
    original_prompt_len: Optional[int] = Field(default=-1)
