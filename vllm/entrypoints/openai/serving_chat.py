    ...
    async def create_chat_completion(
        ...
        try:
            for i, engine_prompt in enumerate(engine_prompts):
                ...
                # --- 【这里添加修改】 ---
                # 从 request 对象中获取自定义字段，并设置到 sampling_params 对象上
                # if request.router_request_id is not None:
                #     sampling_params.router_request_id = request.router_request_id
                # if request.priority is not None:
                #     sampling_params.priority = request.priority
                # --- 修改结束 ---
